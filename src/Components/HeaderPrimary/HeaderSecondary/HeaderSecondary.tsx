  ...
  return (
    <div className="w-full h-28 flex items-center justify-between">
      ...
      <div className="flex w-60 h-20 m-0 sm:mr-8 justify-center items-center gap-2">
        <button className="hidden sm:flex md:flex items-center justify-center bg-inherit w-32 h-10 text-sm text-wrap text-black rounded-3xl border-none outline-none hover:bg-[#c7c7c7] transition-colors">
          Become a host
        </button>
