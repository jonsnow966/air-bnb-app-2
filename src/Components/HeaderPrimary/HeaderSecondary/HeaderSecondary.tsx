function HeaderSecondary() {
  return (
    <div className="w-full h-28 flex items-center justify-between">
      ...
      <div className="w-2/4 h-full ml-14 flex justify-center items-center gap-2">
      ...
      <div className="w-60 h-20 mr-8 flex justify-center items-center gap-2">
        <button className="bg-inherit w-32 h-10 text-sm text-wrap text-black rounded-3xl border-none outline-none hover:bg-[#c7c7c7] transition-colors">
          Become a host
        </button>
