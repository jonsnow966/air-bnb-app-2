...
function SearchBar() {
  ...
  return (
    <div className="bg-slate-50 w-fit rounded-full flex shadow-lg cursor-pointer items-center">

      <div id="search_bar" className="w-64 h-full rounded-full bg-slate-50 flex flex-col pl-8 justify-center hover:bg-slate-200">
      ...
      <div id="check_in_btn" className="w-36 h-full rounded-full bg-slate-50 flex flex-col pl-8 justify-center hover:bg-slate-200"
      ...
      <div id="check_out_btn" className="w-36 h-full rounded-full  bg-slate-50 flex flex-col pl-8 justify-center hover:bg-slate-200"
      ...
      <div id="add_guests_btn" className="w-64 h-full rounded-full  bg-slate-50 flex flex-col pl-8 justify-center hover:bg-slate-200"
      ...
      >
        ...
        <div className="bg-red-500 w-12 h-12 rounded-full flex items-center justify-center z-10 absolute hover:bg-red-600" style={{right: '29.5%'}}>     
